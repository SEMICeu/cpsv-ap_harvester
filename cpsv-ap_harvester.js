...
function clean(){	
	...
	$.ajax({
		type: "GET",
		url: "http://localhost:80/harvester/pages/clear.php",
		data: { },
		async: false,
...
function harvest(){
	...
	$.ajax({
		type: "GET",
		url: "http://localhost:80/harvester/pages/harvest.php",
		data: { p: '1' },
		async: false,
		success: function (response) {
...
function getPropertyName(className, propURI){
	$.ajax({
		type: "GET",
		url: "http://localhost:80/harvester/pages/getProperties.php",
...
function getStoredData (){
	...
	xhttp.open("GET", "http://localhost:80/harvester/pages/getEndPoint.php", false); //synchronized
	xhttp.send();
	...
	if (endpoint != "") {
		...
		xhttp2.open("GET", "http://localhost:80/harvester/pages/show.php", false); //synchronized
		xhttp2.send();
...
function getTriplesURI(URI, classType){
	...
	$.ajax({
		type: "GET",
		url: "http://localhost:80/harvester/pages/getTriplesURI.php",
