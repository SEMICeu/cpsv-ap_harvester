...
function createRow (tableID){
	...
	var tableRef = document.getElementById(tableID).getElementsByTagName('tbody')[0];   // new in v2
...
//	var newCell  = newRow.insertCell(0); // commented in v2
	
//	return newCell; // commented in v2

	return newRow; // added in v2
}
...
//					newCell = createRow (tableID); // commented in v2
					newRow = createRow (tableID); // added in v2
					newCell = newRow.insertCell(0); // added in v2
					...
					case "PeriodofTime":	{
					 ...
					 case "FormalFramework":	{
						if (propURI == "http://data.europa.eu/eli/ontology#id_local"){
							propName = "Name";
							append = true;
						} else if (propURI == "http://purl.org/dc/terms/description"){
							propName = "Description";
							append = true;
						} else if (propURI == "http://purl.org/dc/terms/type"){
							propName = "Type";
							append = true;
						} else if (propURI == "http://purl.org/dc/terms/title"){
                                                        propName = "Name";
                                                        append = true;
                                                }
						break;
